...
//                      FIRMWARE VERSION
// =================================================================
const String FIRMWARE_VERSION = "V1.3.6-fixed-linker";
...
// --- Reset-Logik mit Keypad-Bestätigung ---
  ...
  if (isSumUpTransactionActive) {
    ...
    // 2. STATUS PRÜFEN (Alle 2 Sekunden)
        ...
        tft.fillRect(200, 200, 60, 25, HANIMAT_BG);
 ...
 * @param line1 The first (main) line of the error message (e.g., "FEHLER").
 * @param line2 The second (optional) line of the error message (details).
 */
void displayErrorMessage(const String &line1, const String &line2) {
